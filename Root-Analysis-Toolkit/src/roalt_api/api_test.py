...
from roalt_api.app.core.logging_config import setup_logging
from roalt_api.app.middlewares.logging_middleware import LoggingMiddleware
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            predict_masks(
                ...
                model_path = Path("./best_unet_model.pth"),
...
#run from Root-Analysis-Toolkit/src: python ./roalt_api/api_test.py